...
train, test, train_size, test_size, train_ratio, indices = split_train_test(full_signal, n_qubits)
final_train, final_test, scaler = scale_data(train, test, train_size, test_size, n_qubits)
# %%
weights, x_t, target_y_t = train_model(final_train, final_test, weights, circuit, n_qubits, max_steps = 10, epochs = 10, bool_plot=True)
# %%
results_and_params = {
    "n_qubits" : n_qubits,
    "indices" : indices,
