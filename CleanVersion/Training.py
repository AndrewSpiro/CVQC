...
# %%
weights, x_t, target_y_t = train_model(final_train, final_test, weights, circuit, n_qubits, max_steps = 10, epochs = 100, bool_plot=True, save_plot='Results/TEST/TEST loss')
# %%
results_and_params = {
    "n_qubits" : n_qubits,
    "indices" : indices,
