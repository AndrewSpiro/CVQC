...
_, circuit, _, n_qubits = initialize_Ising_circuit(bool_draw = True)
...
plot(predictions, targets, indices, n_qubits, bool_plot = True, save_plot= 'Results/TEST/TEST predictions JAX', mse = mse, forward_mse=forward_mse, plot_labels=['Day','Percent of Change'])
# %%