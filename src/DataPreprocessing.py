...
dataset = load_data('Datasets/' + Data + '.csv',usecols=['Close'], sample_size=sample_size)
...
full_signal, r = build_signal(DC, amp, Noise, Trend, N, bool_plot=True, labels = ['Title', 'X-axis', 'Y-axis'])